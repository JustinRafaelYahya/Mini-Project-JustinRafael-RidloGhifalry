...
const MainPage = () => {
  ...
  return (
    <div className="py-[4rem] mx-auto px-12 bg-white max-w-[1400px]">
      ...
      <Categories
        className="w-full grid grid-cols-2 sm:grid-cols-6 gap-12 text-center cursor-pointer mx-auto mb-12"
        categories={categories}
        divClass="bg-slate-100 opacity-100 shadow-sm shadow-gray-400 rounded-full hover:scale-110 duration-500 p-8"
      />
      {/* </div> */}
