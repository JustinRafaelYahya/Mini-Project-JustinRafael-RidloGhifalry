...
export default function Footer() {
  return (
    <footer className="bg-white border border-t-gray-100">
      <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center">
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-main-color">
                eventnow
              </span>
            </Link>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-10">
            ...
            <div>
              ...
              <ul className="text-gray-500 font-medium space-y-4">
                ...
                <li className="hover:underline">Brand Center</li>
