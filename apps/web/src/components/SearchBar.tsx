...
const SearchBar = () => {
  ...
  return (
    <>
      <Link href="/">
        <RxCross2
          className="float-right mt-24 mx-auto mr-8 rounded-full hover:bg-slate-500 p-2"
          size={50}
        />
      </Link>
      <div className="py-[4rem] mx-auto px-12 bg-white max-w-[1400px] h-screen">
        ...
        <select
          className=" m-auto rounded-lg p-2 border-[1px] border-slate-300 flex mx-auto mb-6"
          value={location}
